...
<!-- ![]( images/tmux0_session.gif) -->
<!-- <img src="images/tmux0_session.gif" width=400/> -->
...
![](images/tmux-sessions-windows-panes-01.svg)
...
![](images/tmux_statusbar_default_left.png)
![](images/tmux_statusbar_default_right.png)


Through tmux.conf (see later) we can customize as we wish, for example:

![](images/tmux_status_left.png)
![](images/tmux_status_right.png)

Note that if a window is in full-screen mode then 'Z' is appended to that window name

![](images/tmux_status_left_Z.png)
